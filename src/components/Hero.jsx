...
const decoLineVariant = {
  ...
  visible: {
    width: 64,
    opacity: 1,
    transition: { delay: 1.5, duration: 0.9, ease: [0.4, 0, 0.2, 1] },
  },
};
...
className="relative z-40 max-w-7xl mx-auto px-6 md:px-12 py-24 md:py-28 grid md:grid-cols-2 gap-12 md:gap-16 items-center"      >
        {/* LEFT */}
        <div>
          <motion.div
          ...
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
className="font-playfair text-4xl sm:text-5xl md:text-7xl leading-[1.1] mb-4"          >
            <div className="overflow-hidden">
              <motion.div variants={lineVariant}>Fresh &amp;</motion.div>
            </div>
            <div className="overflow-hidden pb-1">
              <motion.div
                variants={lineVariant}
                className="text-[#A2B568] italic"
              >
                Premium Quality
              </motion.div>
            </div>
            <div className="overflow-hidden">
              <motion.div variants={lineVariant}>Fruits</motion.div>
            </div>
          </motion.h1>
...
className="flex flex-col sm:flex-row gap-4 mb-10"          >
            <a
              href="#products"
              className="btn-primary px-8 py-4 text-sm tracking-wider uppercase text-white"
            >
              Explore Products
            </a>
            ...
            <a
              href="#contact"
              className="border border-white hover:bg-white hover:text-[#15282F] px-8 py-4 text-sm tracking-wider uppercase transition duration-300 backdrop-blur-sm bg-white/10"
            >
              Get a Quote
            </a>
          </motion.div>
        ...
        <div className="hidden md:flex relative justify-center items-center" style={{ minHeight: 520 }}>
          <motion.div
            variants={cardStack}
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to top, rgba(17,70,67,0.65) 0%, transparent 55%)",
                  zIndex: 1,
                }}
              />
            </motion.div>
            ...
            >
              <p className="text-[10px] tracking-[0.2em] uppercase text-[#15282F] font-bold">
                Farm Fresh
              </p>
            </motion.div>
          </motion.div>
